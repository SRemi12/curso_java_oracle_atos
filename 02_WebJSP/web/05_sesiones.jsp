<%-- 
    ...
    Created on : 20-feb-2019, 14:03:59
    Author     : USUARIO
--%>
    ...
    <body>
        ...
        <%
          ...
          if (numeroGet !=null){
              ...
              if(error) //MAL concluimos vista en lógica de negocio
                  out.println("<p style='color: red'>Indicar un número mayor que cero</p>");
              else
         ...
         // }
          ...
          totalPeticiones++;
        %>
        <p>Ejecuciones de este JSP: <%= totalPeticiones %></p>
    </body>
</html>
